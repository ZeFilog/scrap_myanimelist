...
def get_liens(recherche): # Making a GET request to the specified URL with the user's search query included
    ...
    with open ('page_de_recherche_alexis', 'w', encoding="utf-8") as file: # Writing the response to a file named "code_ao"
        file.write(response.text)
    with open('page_de_recherche_alexis', 'r', encoding="utf-8") as file:  # Reading the file again
        main = file.read()
        #print(id_liens)
